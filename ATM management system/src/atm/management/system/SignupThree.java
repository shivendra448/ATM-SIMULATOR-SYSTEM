...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree( String formno) {
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-3138");
        ...
        pindetail.setBounds(100,285,300,20);
        add(pindetail );
        ...
        c1.setBounds(100,365,200,30);
        add(c1);
        
        c2 =  new JCheckBox("Internet Banking");
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway",Font.BOLD,15));
        c2.setBounds(350,365,200,30);
        add(c2);
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == submit) {
                ...
                String cardnumber = "" + Math.abs((random.nextLong() % 90000000L) + 6549806400000000L);
